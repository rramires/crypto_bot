    ...
    ***************************************************************************** */
	...
	var NotyfView = /** @class */ (function () {
		...
		NotyfView.prototype.on = function (event, cb) {
			var _a
			this.events = __assign(
				__assign({}, this.events),
				((_a = {}), (_a[event] = cb), _a),
			)
		}
			...
			return (
				((_a =
					options === null || options === void 0
						? void 0
						: options.position) === null || _a === void 0
					? void 0
					: _a.x) || 'right'
			)
		}
		...
		NotyfView.prototype._buildNotificationCard = function (notification) {
			...
			if (iconOpts && typeof iconOpts === 'object') {
				...
				var iconColor =
					(_a = iconOpts.color) !== null && _a !== void 0 ? _a : color
				if (iconColor) {
			...
			if (options.dismissible) {
				...
				dismissButton.addEventListener('click', function (event) {
					var _a, _b
					;(_b = (_a = _this.events)[NotyfEvent.Dismiss]) === null ||
					_b === void 0
						? void 0
			...
			notificationElem.addEventListener('click', function (event) {
				var _a, _b
				return (_b = (_a = _this.events)[NotyfEvent.Click]) === null ||
					_b === void 0
					? void 0
					: _b.call(_a, { target: notification, event: event })
			})
			...
			var className =
				this.getYPosition(options) === 'top' ? 'upper' : 'lower'
	...
	var Notyf = /** @class */ (function () {
		...
		Notyf.prototype.assignProps = function (props, config) {
			...
			props.forEach(function (prop) {
				...
				config[prop] =
					config[prop] == null ? _this.options[prop] : config[prop]
			})
		}
		...
		Notyf.prototype.registerTypes = function (opts) {
			...
			var finalDefaultTypes = DEFAULT_OPTIONS.types.map(
				function (defaultType) {
					...
					var userType =
						userTypeIdx !== -1
							? incomingTypes.splice(userTypeIdx, 1)[0]
							: {}
